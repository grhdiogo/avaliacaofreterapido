...
type Shipper struct {
	RegisteredNumber string `json:"registered_number"` // required
	Token            string `json:"token"`             // required
	PlatformCode     string `json:"platform_code"`     // required
}

type Recipient struct {
	Type             RecipientKind `json:"type"`                        // required
	...
	Zipcode          int           `json:"zipcode"`                     // required
}
...
type DispatcherVolume struct {
	...
	UnitaryPrice  float64 `json:"unitary_price"`            // required
	UnitaryWeight float64 `json:"unitary_weight"`           // required
...
type Dispatcher struct {
	...
	Volumes          []DispatcherVolume `json:"volumes,omitempty"`     // required
}
...
type CreateFreightQuotationRequest struct {
	Shipper        Shipper                    `json:"shipper"`                  // required
	Recipient      Recipient                  `json:"recipient"`                // required
	Dispatchers    []Dispatcher               `json:"dispatchers"`              // required
	...
	SimulationType []ReturnSimulationTypeKind `json:"simulation_type"`          // required
	Returns        *Returns                   `json:"returns,omitempty"`        // optional
}

type CreateFreightQuotationResponse struct {
	Dispatchers []CreateFreightQuotationResponseDispatcher `json:"dispatchers"`
}

type CreateFreightQuotationResponseDispatcher struct {
	ID                         string                                           `json:"id"`
	...
	Offers                     []CreateFreightQuotationResponseDispatcherOffer  `json:"offers"`
	Volumes                    []CreateFreightQuotationResponseDispatcherVolume `json:"volumes"`
}

type CreateFreightQuotationResponseDispatcherVolume struct {
...
type CreateFreightQuotationResponseDispatcherOfferCarrier struct {
...
type CreateFreightQuotationResponseDispatcherOfferDeliveryTime struct {
	Days          int    `json:"days"`
...
type CreateFreightQuotationResponseDispatcherOfferWeights struct {
	Real  float64 `json:"real"`
	Cubed float64 `json:"cubed"`
	Used  float64 `json:"used"`
}

type CreateFreightQuotationResponseDispatcherOfferCompositionSubTotal1 struct {
...
type CreateFreightQuotationResponseDispatcherOfferCompositionSubTotal2 struct {
	Trt        int `json:"trt"`
	Tda        int `json:"tda"`
	Tde        int `json:"tde"`
...
type CreateFreightQuotationResponseDispatcherOfferCompositionSubTotal3 struct {
	Icms int `json:"icms"`
}

type CreateFreightQuotationResponseDispatcherOfferComposition struct {
	...
	SubTotal1           CreateFreightQuotationResponseDispatcherOfferCompositionSubTotal1 `json:"sub_total1"`
	SubTotal2           CreateFreightQuotationResponseDispatcherOfferCompositionSubTotal2 `json:"sub_total2"`
	SubTotal3           CreateFreightQuotationResponseDispatcherOfferCompositionSubTotal3 `json:"sub_total3"`
}

type CreateFreightQuotationResponseDispatcherOfferOriginalDeliveryTime struct {
	Days          int    `json:"days"`
	Hours         int    `json:"hours"`
	Minutes       int    `json:"minutes"`
	EstimatedDate string `json:"estimated_date"`
...
type CreateFreightQuotationResponseDispatcherOfferEsg struct {
	Co2EmissionEstimate float64 `json:"co2_emission_estimate"`
	Co2EmissionCost     float64 `json:"co2_emission_cost"`
}

type CreateFreightQuotationResponseDispatcherOffer struct {
	Offer                int                                                               `json:"offer"`
	SimulationType       int                                                               `json:"simulation_type"`
	Carrier              CreateFreightQuotationResponseDispatcherOfferCarrier              `json:"carrier"`
	Service              string                                                            `json:"service"`
	ServiceCode          string                                                            `json:"service_code"`
	ServiceDescription   string                                                            `json:"service_description"`
	DeliveryTime         CreateFreightQuotationResponseDispatcherOfferDeliveryTime         `json:"delivery_time"`
	Expiration           string                                                            `json:"expiration"`
	CostPrice            float64                                                           `json:"cost_price"`
	FinalPrice           float64                                                           `json:"final_price"`
	Weights              CreateFreightQuotationResponseDispatcherOfferWeights              `json:"weights"`
	Composition          CreateFreightQuotationResponseDispatcherOfferComposition          `json:"composition"`
	OriginalDeliveryTime CreateFreightQuotationResponseDispatcherOfferOriginalDeliveryTime `json:"original_delivery_time"`
	Identifier           string                                                            `json:"identifier"`
	HomeDelivery         bool                                                              `json:"home_delivery"`
	Modal                string                                                            `json:"modal"`
	Esg                  CreateFreightQuotationResponseDispatcherOfferEsg                  `json:"esg"`
}
